...
var validatePrompt = {
    regName: {
        ...
        isNull: "请输入用户名",
        error: {
            beUsed: "该用户名已被使用，请重新输入。如果您是该用户，请立刻<a href='https://passport.taotao.com/uc/login' class='flk13'>登录</a>",
...
$(function() {
    $('#protocol').click(function() {
        jQuery.jdThickBox({
            ...
            "    <p>" + "        本协议是您与淘淘网站（简称\"本站\"，网址：www.taotao.com）所有者（以下简称为\"淘淘\"）之间就淘淘网站服务等相关事宜所订立的契约，请您仔细阅读本注册协议，您点击\"同意并继续\"按钮后，本协议即构成对双方有约束力的法律文件。</p>" + "    <h5> 第1条 本站服务条款的确认和接纳</h5>" +
