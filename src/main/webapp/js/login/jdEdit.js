			...
			checkInstall: function() {
				try {
					if (this.osBrowser==1) {
						...
						var comActiveX = new ActiveXObject("TTedit.TTeditCtrl.1");

					} else if (this.osBrowser==2) {

					    var arr=new Array();
					    var pge_info=navigator.plugins['TTedit'].description;
						...
						var comActiveX = new ActiveXObject("TTeditX64.TTeditCtrl.1");
					}else{
						return false;
					}
				}catch(e){
