...
function setArea() {
    ...
    a.def = {text: n,val: i}, e.find("ul").eq(0).after(s.process(a)), t = $("#home-area"), t.Jdropdown({event: "click"}), t.find(".dd ul a[data-id]").click(function() {
        ...
        createCookie("areaId", e, 10, "/;domain=taotao.com"), createCookie("ipLoc-djd", e + "-0-0-0", 10, "/;domain=taotao.com"), location.href = "http://www.taotao.com/", t.removeClass("hover")
    })
}
...
//    var t = function(t) {
//        if (0 !== t.type) {
//            var e = $("#header-2013"), i = $('<div id="jd-ept-link" style="height: 60px;margin-bottom:10px;"></div>'), a = "http://en.taotao.com/", n = '<div class="w" clstag="homepage|keycount|home2013|ept"><a target="_blank" href="' + a + '" style="display: block;text-align: center;border: 2px solid #F0AF00;background: #FFFBDD url(/images/blank.gif);">' + '<img style="vertical-align: top;" class="loading-style2" data-img="1" src="http://img.taotao.com/da/g14/M03/1E/18/rBEhVlNUvcEIAAAAAAAgBol2wPcAAMVkwEJL5gAACAe087.png" width="874" height="56" />' + "</a></div>";
//            i.html(n), e.after(i)
//        }
//    };
//    $.ajax({url: "http://ai.taotao.com/jdip/useripinfo.php",dataType: "jsonp",success: function(e) {
//            void 0 !== e && t(e)
//        }})
}
function hotSaleMod(t) {
    (function() {
        ...
        $.ajax({url: "http://x.taotao.com/ShowInterface",data: {ad_type: 7,spread_type: 1,ad_ids: "269:" + n,template: 0,callback: "?"},scriptCharset: "utf-8",dataType: "jsonp",success: function(e) {
...
ABTest.prototype = {test: function() {
        ...
        window.collectUUUID = function(t) {
            e(t)
        }, $.ajax({url: "http://fa.taotao.com/loadFa_toJson.js?aid=2_163_4827-2_163_4828",dataType: "jsonp",cache: !0,success: function() {
            }})
        ...
        if (!t || !/A|B|N/.test(t))
            return console.warn("Are you kidding me~ Is there a test.JSON version called " + t + "?"), !1;
        this.tested || console.warn("Please run test.JSON method first.");
        var e = this.result[t], i = e[Math.floor(Math.random() * e.length)];
        createCookie("__jda", "122270672." + i + ".043878.1386043878.1386043878.1", 10, "/;domain=taotao.com"), console.log(i)
...
var Floors = {cacheData: null,data: function(t) {
        ...
        var e = this;
        $.ajax({url: "http://ai.taotao.com/",dataType: "jsonp",success: function(i) {
...
(function() {
    document.referrer.match(/^http:\/\/\S*\.360buy\.com/) && !$.cookie("_fv") && $("#shortcut-2013 .fl li").append('<div class="jtip"><div class="jtip-arrow"><div class="jtip-arrow1"></div><div class="jtip-arrow2"></div></div><div class="jtip-content">\u628a\u4eac\u4e1c\u52a0\u5165\u6536\u85cf\u5939<br />\u4e00\u952e\u8f7b\u677e\u8bbf\u95eetaotao.com</div><div class="jtip-close" onclick="this.parentNode.style.display=\'none\'">\u00d7</div></div>'), $(".plist .style1 .p-img,.plist .style2 .p-img").bind("mouseover", function() {
    ...
    $("#virtuals").Jtab({type: "dynamic",index: t,source: "data-url",delay: 200}, function(t, e, i) {
        ...
        $.ajax({url: "http://edm.taotao.com/front/ajax/subscribe.ashx",data: {email: t,type: 1},dataType: "jsonp",success: function(t) {
                if (t) {
                    switch (t.state) {
                        case 0:
                            i = "correct";
    ...
    var a = function(t) {
        $.getJSON("http://passport.taotao.com/loginservice.aspx?method=Login&callback=?", function(e) {
            t && t(e)
        })
    };
    new BackPanelNew({id: "backpanel0708",start: 10}).init({text: "\u8fd4\u56de\u9876\u90e8",fn: function() {
            $("body,html").animate({scrollTop: 0}, 300, "easeOutExpo")
        }}).add({cName: "survey",text: "\u6211\u8981\u53cd\u9988",target: "_blank",href: "http://surveys.taotao.com/index.php?r=survey/index/sid/95425/lang/zh-Hans"}), pageConfig.backTopFloor = new BackPanelNew({id: "backpanel-floor",start: 10,fadeIn: 500,onShow: function(i) {
        ...
        e && (pageConfig.backTopFloor.add({cName: "home-setting",text: "\u6211\u8981\u8bbe\u7f6e",href: "#none",dir: "bottom",fn: function() {
                "undefined" == typeof HomeSetting ? $.ajax({url: "http://taotao.com/product/js/2013/home-settings.js",dataType: "script",cache: !0,scriptCharset: "utf-8"}) : HomeSetting.init("#home-setting")
