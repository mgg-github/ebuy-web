    ...
    var t = require("conf"), e = require("load_async"), a = _.Class.extend({
        ...
        render: function (t) {
            ...
            for (e = 0; e < $; e++) {
                ...
                for (_ > 0 && _ % 2 == 1 && (h += '<a><img data-lazy-img="//img10.360buyimg.com/da/jfs/t757/162/604852976/158/9ed36f8/54c8699bNc2cfc6a1.png" src="//taotao.com/mtd/pc/common/img/blank.png" /></a>'), h = '<div class="cate_brand" clstag="' + A(T(e), "e") + '">' + h + "</div>", v += h, k = "", n = a.p.length, i = 0; i < n; i++)i < 2 && (k += b.getLinkHtml({
                    str: a.p[i],
