define("home/widget/cate", function (require) {
    ...
    var t = require("conf"), e = require("load_async"), a = _.Class.extend({
        ...
        render: function (t) {
            ...
            for (e = 0; e < $; e++) {
                for (a = x[e], C = '<div class="cate_part_col1">', p = "", n = a.t.length, i = 0; i < n; i++)
                //     p += b.getLinkHtml({
                //     str: a.t[i],
                ...
                // });
                for (p = '<div class="cate_channel" clstag="' + A(T(e), "b") + '">' + p + "</div>", C += p, f = "", n = a.s.length, i = 0; i < n; i++)for (l = a.s[i], c = l.s.length, s = 0; s < c; s++) {
                    if (o = l.s[s].s, u = b.getLinkHtml({
                        ...
                        }), m = '<dt class="cate_detail_tit" clstag="' + A(T(e), "c", T(s)) + '">' + u + "</dt>", g = "", 0 != o)for (r = o.length, d = 0; d < r; d++)g += b.getLinkHtml({
                        str: o[d].n,
                ...
                for (_ > 0 && _ % 2 == 1 && (h += '<a><img data-lazy-img="//img10.360buyimg.com/da/jfs/t757/162/604852976/158/9ed36f8/54c8699bNc2cfc6a1.png" src="//taotao.com/mtd/pc/common/img/blank.png" /></a>'), n = a.p.length, i = 0; i < n; i++)i < 2
                y += '<div class="cate_part clearfix" id="cate_item' + (e + 1) + '" data-id="' + a.id + '">' + C  + "</div>"
            }
