!function (e, t) {
    ...
    function c(e) {
        var t, r = A.paths;
        return r && (t = e.match(U)) && w(r[t[1]]) && (e = r[t[1]] + t[2]), e
    }
    ...
    function l(e) {
        ...
        if (t)for (var n = 0, i = t.length; i > n; n++) {
            var a = t[n];
            if (r = j(a) ? a(e) || e : e.replace(a[0], a[1]), r !== e)break
        }
        return r
    }
    ...
    if (!e.seajs) {
        var E = e.seajs = {version: "2.2.0"}, A = E.data = {}, _ = r("Object"), w = r("String"),
            x = Array.isArray || r("Array"), j = r("Function"), T = 0, C = A.events = {};
        E.on = function (e, t) {
            var r = C[e] || (C[e] = []);
            return r.push(t), E
        }, E.off = function (e, t) {
        ...
        var X,
            ...
            W = /\\\\/g, J = E.cache = {}, Q = {}, Z = {}, ee = {},
            te = b.STATUS = {FETCHING: 1, SAVED: 2, LOADING: 3, LOADED: 4, EXECUTING: 5, EXECUTED: 6};
        b.prototype.resolve = function () {
            ...
            var a = r.factory, o = j(a) ? a(e, r.exports = {}, r) : a;
            ...
            1 === i ? (n = e, e = t) : 2 === i && (n = r, x(e) ? (r = e, e = t) : r = t), !x(r) && j(n) && (r = y("" + n));
        ...
        A.base = ($.match(re) || ["", $])[1], A.dir = $, A.cwd = M, A.charset = "utf-8", A.preload = function () {
            ...
            for (var t in e) {
                var r = e[t], n = A[t];
                if (n && _(n))for (var i in r)n[i] = r[i]; else x(n) ? r = n.concat(r) : "base" === t && ("/" !== r.slice(-1) && (r += "/"), r = f(r)), A[t] = r
            }
            return S("config", e), E
        }
    }
    ...
    t.isdebug = function () {
    ...
    }(), t.baseUri = t.baseUri || "//taotao.com/", t.imageLazyload = !0, t.getDomain = function () {
        var e = location.hostname, t = "taotao.com";
        return /\byiyaotaotao.com\b/.test(e) ? t = "yiyaotaotao.com" : /taotao.com/.test(e) ? t = "taotao.com" : /jd360.hk/.test(e) ? t = "jd360.hk" : /jd.hk/.test(e) ? t = "jd.hk" : /taotao.com/.test(e) && (t = "taotao.com"), t
        ...
        return "//imgtaotao.com/".replace("{0}", t)
        ...
        return e ? e.replace(/^http(s?):/, "").replace(/(360buyimg\.com\/[^\/]+)\/([^\/]+)/, function (e, i, a) {
            var o = a.replace(/s\d+x\d+_([\s\S]+)/, function (e, t) {
                return t
            });
            return [i, "/s", t.isRetina ? r : n, "_", o].join("")
        }) : ""
    }, t.replaceMImageUrl = function (e, r) {
        return e ? e.replace(/^http(s?):/, "").replace(/\/\/m.taotao.com\//, function () {
        ...
        return location.href = "https://passport.taotao.com/new/login.aspx?ReturnUrl=" + escape(location.href).replace(/\//g, "%2F"), !1
    }, e.regist = function () {
        return location.href = "https://reg.taotao.com/reg/person?ReturnUrl=" + escape(location.href), !1
