	...
	<div class="invoice">
		<div class="invoice-content">
				...
				<div id="step-4" class="step step-complete">
					<div class="step-title hide"><a href="http://cart.taotao.com/cart/cart.html" id="cartRetureUrl" class="return-edit">返回修改购物车</a><strong>商品清单</strong></div>
					<div class="step-content">
...
<!--**********商品清单内容列表结束************-->
										...
										<div class="order-summary">
											<div class="summary-form fl">
												<div class="safe-tip" style="display:none" id="safeVerciryPromptPart">&nbsp;&nbsp;&nbsp;&nbsp;为保障您的账户资金安全，余额暂时不可用，请先<a target="_blank" href="http://safe.taotao.com/user/paymentpassword/safetyCenter.action">开启支付密码</a></div>
																							</div>
											<!--  预售 计算支付展现方式 begin -->
...
<div class="bt bt-w freight-tooltip hide" id="transport">
   ...
   <div class="w">
	...
	$('#bill-tip-btn').Jtips({//随点随帮tip弹出
		"content":'<a target="_blank" href="http://help.taotao.com/help/question-61.html#kjfpf">如何区分淘淘销售和第三方卖家销售的商品?</a>',
		"close":true,			
	    "position": 'bottom'
	});
	//<![CDATA[
