...
<div class="w" id="regist">
    <div class="mt">
        <ul class="tab">
            ...
            <li class="fore hide"><a href="http://passport.en.taotao.com/user/facade">International Customers</a></li>
        </ul>
        <div class="extra">
        <span style="text-align: right">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a class="flk13"
                                                                               onclick="javascript:location.href=&quot;http://en.taotao.com&quot;+location.search;"
