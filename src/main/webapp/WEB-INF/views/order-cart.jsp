			...
			<ul id="payment-list">
				...
				<div class="payment-item  online-payment " for="pay-method-1"
					payname="货到付款" payid="1"><b></b>
					    					货到付款<span class="qmark-icon qmark-tip" data-tips="送货上门后再收款，支持现金、POS机刷卡、支票支付 <a href='http://help.taotao.com/help/distribution-768-2-2813-2863-0-1410707152669.html' target='_blank' class='ftx-05'>查看服务及配送范围</a>"></span>					                                        																										<!--  span class="qmark-icon qmark-tip" data-tips="在线支付，支持绝大多数银行借记卡及部分银行信用卡 <a href='http://help.taotao.com/help/question-68.html' target='_blank' class='ftx-05'>查看银行及限额</a>"></span -->
					<!-- span class="qmark-icon qmark-tip" data-tips="送货上门后再收款，支持现金、POS机刷卡、支票支付 <a target='_blank' href='http://psfw.taotao.com/help/distribution-768.html-2-2825-2893-0-1427094595258.html'>查看服务及配送范围</a>"></span -->
				</div>
			</li>
            ...
            <!-- 分期付款干掉
             -->
				...
				<div class="payment-item item-selected online-payment " for="pay-method-5"
					...
					公司转账                                        																					<span class="qmark-icon qmark-tip" data-tips="通过快钱平台转账 转帐后1-3个工作日内到帐 <a href='http://help.taotao.com/help/question-70.html' target='_blank' class='ftx-05'>查看帐户信息</a>"></span> 					<!--  span class="qmark-icon qmark-tip" data-tips="在线支付，支持绝大多数银行借记卡及部分银行信用卡 <a href='http://help.taotao.com/help/question-68.html' target='_blank' class='ftx-05'>查看银行及限额</a>"></span -->
					<!-- span class="qmark-icon qmark-tip" data-tips="通过快钱平台转账 转帐后1-3个工作日内到帐 <a target='_blank' href='http://help.taotao.com/help/question-70.html'>查看帐户信息</a>"></span -->
				</div>
			</li>
            ...
            <!-- 分期付款干掉
             -->
				...
				<div class="payment-item  online-payment " for="pay-method-2"
					...
					邮局汇款                                        													<span class="qmark-icon qmark-tip" data-tips="通过快钱平台收款 汇款后1-3个工作日到账 <a href='http://help.taotao.com/help/question-69.html' target='_blank' class='ftx-05'>查看帮助</a>"></span>													<!--  span class="qmark-icon qmark-tip" data-tips="在线支付，支持绝大多数银行借记卡及部分银行信用卡 <a href='http://help.taotao.com/help/question-68.html' target='_blank' class='ftx-05'>查看银行及限额</a>"></span -->
					<!-- span class="qmark-icon qmark-tip" data-tips="通过快钱平台收款  汇款后1-3个工作日到账 <a target='_blank' href='http://help.taotao.com/help/question-69.html'>查看帮助</a>"></span -->
				</div>
			</li>
         ...
         <!--配送方式-->
                  ...
                  <div class="mode-tab-nav">
                    <ul>
						...
						<span class="m-txt">上门自提<i class="qmark-icon qmark-tip" data-tips="自提时付款，支持现金、POS刷卡、支票支付<a href='http://help.taotao.com/help/question-64.html' target='_blank' class='ftx-05'>查看自提流程</a>"></i></span><b></b>
                      </li>
                    </ul>
                  </div>
...
<div class="form picksite-box">
 ...
 021-64290343</span>
    							<a href="http://help.taotao.com/help/question-66.html#pjzgztg" target="_blank" class="ftx-05 map-link">详细地图</a>
    						</div>
    						<div class="clr"></div>
    					</div>
    				    ...
    				    <div pickid="341" pickName="颛桥站"  class="site-item"  pickName="颛桥站" >
    						...
    						<div class="field">
    							...
    							<a href="http://help.taotao.com/help/question-101.html#shanghaizhuanqiao" target="_blank" class="ftx-05 map-link">详细地图</a>
    						</div>
    						<div class="clr"></div>
    					</div>
    				    ...
    				    <div pickid="1411" pickName="金州站"  class="site-item"  pickName="金州站" >
    						...
    						<div class="field">
    							...
    							<a href="http://help.taotao.com/help/question-101.html#shanghaijinzhou" target="_blank" class="ftx-05 map-link">详细地图</a>
    						</div>
    						<div class="clr"></div>
    					</div>
    				    ...
    				    <div pickid="4532" pickName="新梅莘苑自提柜"  class="site-item"  pickName="新梅莘苑自提柜" >
    						...
    						<div class="field">
    							...
    							<a href="http://help.taotao.com/help/question66.html#xmxy
" target="_blank" class="ftx-05 map-link">详细地图</a>  
    				    ...
    				    <div pickid="4533" pickName="海德名园自提柜"  class="site-item"  pickName="海德名园自提柜" >
    						...
    						<div class="field">
    							...
    							<a href="http://help.taotao.com/help/question-66.html#haidemingyuan" target="_blank" class="ftx-05 map-link">详细地图</a>
    						</div>
    						<div class="clr"></div>
    					</div>
	...
	<div class="item">
		...
		<div class="fl">
			...
			<div class="ftx-03 mt10">自提时付款，支持现金、POS刷卡、支票支付 <a class="ftx-05" href="http://help.taotao.com/help/question-64.html#help170" target="_blank">查看自提流程</a></div>
		</div>
	</div>
</div>
           ...
           jQuery.closeDialog();
							   ...
							   <div class="hide" id="jdItem_surpportSku">
    									...
    									<div class="goods-items">
    												...
    												<div class="p-img">
    													<a href="#none"><img src="http://img.taotao.com/N4/jfs/t274/191/1323012102/354214/23ee9085/5437845cN5d6b6205.jpg" alt=""></a>
    												</div>
    												<div class="p-name">
    ...
    <div id="backpanel">
        <div id="backpanel-inner" class="hide"> 
            <div class="bp-item bp-item-survey">
                <a href="http://surveys.taotao.com/index.php?r=survey/index/sid/584338/lang/zh-Hans" class="survey" target="_blank">我要反馈</a>
            </div>
