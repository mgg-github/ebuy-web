seajs.config({
    paths: {
        TB_ROOT: "//taotao.com/devfe/toolbar/1.0.0",
        TTF_UI: "//taotao.com/1.0.0/ui",
        TTF_UNIT: "//taotao.com/1.0.0/unit"
    }
}), define("toolbar", ["TTF_UNIT/trimPath/1.0.0/trimPath", "TTF_UNIT/login/3.0.0/login", "TB_ROOT/widget/common/common.css", "TB_ROOT/js/localStorageObj"], function (require, exports, module) {
    function t(t) {
        this.settings = $.extend(!0, {}, a, t), this.onOpen = t.onOpen || function () {
            }, this.onClose = t.onClose || function () {
            }, this.onSwitch = t.onSwitch || function () {
            }, this.onLogin = t.onLogin || function () {
            }, this.settings.links.top.href && delete this.settings.links.top.anchor, this.settings.links.feedback.anchor && delete this.settings.links.feedback.href, this.init()
    }

    var e = (require("TTF_UNIT/trimPath/1.0.0/trimPath"), require("TTF_UNIT/login/3.0.0/login")),
        i = (require("TB_ROOT/widget/common/common.css"), require("TB_ROOT/js/localStorageObj").localStorage), a = {
            $el: $("#J-global-toolbar"),
            pType: "",
            enabled: !0,
            bars: {
                jdvip: {
                    ...
                    login: !0,
                    vip: "1",
                    iframe: "//vip.taotao.com/sideBar/index.html"
                },
                cart: {
                    index: 1,
                    enabled: !0,
                    title: "购物车",
                    href: "//cart.taotao.com/cart.action?r=" + Math.random(),
                ...
                history: {
                    ...
                    enabled: !0,
                    title: "我的足迹",
                    href: "//my.taotao.com/history/list.html",
                ...
                message: {
                    ...
                    enabled: !0,
                    title: "我的消息",
                    target: "//joycenter.taotao.com/msgCenter/queryHistoryMessage.action"
                },
                jimi: {
                    index: 5,
                    enabled: !0,
                    title: "咨询JIMI",
                    login: !0,
                    iframe: "//jimi.taotao.com/index.action?source=jdhome"
                }
            },
            links: {
                top: {title: "顶部", anchor: "#shortcut-2013"},
                feedback: {title: "反馈", href: "//diaoyan.taotao.com/survey/answerSurvey.htm?eSurveyId=AZDFYX5KJGMOK"}
            },
            ad: {
                enabled: !0,
                id: "0_0_7209",
                startTime: +new Date(2015, 9, 26, 0, 0, 1) / 1e3,
                endTime: +new Date(2015, 10, 13, 0, 0, 0) / 1e3
            }
        }, s = function (t) {
    ...
    pageConfig.__toolbarLogin = function (t) {
        seajs.use("TTF_UNIT/login/1.0.0/login", function (e) {
            e({
        ...
        init: function () {
            ...
            var t = this, e = t.settings.$el.find(".jdm-toolbar-tabs");
            $.ajax({
                url: "//vip.taotao.com/gift/getWaitReceiveGift.html",
                scriptCharset: "utf-8",
                dataType: "jsonp",
                success: function (a) {
                    var s = "", n = a.result.gifts;
                    a.success && n.length && (s = 1 == n.length ? '<div class="poptip"><i class="giftMsg"></i><b class="giftTxt">您有一个' + n[0].name + '待领取！</b><em class="giftClose"></em><span class="poptip-arrow poptip-arrow-right"><em>◆</em><i>◆</i></span></div>' : '<div class="poptip"><i class="giftMsg"></i><b class="giftTxt">你有' + n.length + '个礼包待领取！</b><em class="giftClose"></em><span class="poptip-arrow poptip-arrow-right"><em>◆</em><i>◆</i></span></div>', e.append(s), $(".poptip .giftClose").unbind("click").bind("click", function () {
                        return $(".poptip").fadeOut(300, function () {
                            $(".poptip").remove(), i.set(t.bubbleKey)
                        }), !1
                    }), $(".poptip").unbind("click").bind("click", function () {
                        $(".jdm-tbar-tab-jdvip").trigger("click"), $(".poptip").fadeOut(300, function () {
                            $(".poptip").remove()
                        })
                    }))
                }
            ...
            try {
                if (this.settings.ad && this.settings.ad.startTime && this.settings.ad.id) {
                    ...
                    var t, e, i = (new Date).valueOf() / 1e3;
                    window.pageConfig && window.pageConfig.timestamp ? (e = window.pageConfig.timestamp / 1e3, t = i - e < 300 && i - e > 0 ? i : e) : t = i;
                    var a;
                    (a = window.location.search.match(/isdebugToolbarTime=(\d+)/)) && (t = parseInt(a[1], 10)), t > this.settings.ad.startTime && t < this.settings.ad.endTime && this.loadAD()
                } else this.settings.ad = null
            } catch (s) {
                this.settings.ad = null
            }
        }, loadAD: function () {
            var t = this, e = "//nfa.taotao.com/loadFa_toJson.js?aid=" + this.settings.ad.id;
            $.ajax({
                url: e, dataType: "script", scriptCharset: "gbk", success: function (e) {
                    t.settings.bars.ad = {name: "ad", iframe: t.$wrap.find(".jdm-tbar-panel-ad").attr("data-iframe")}
                }
            })
        }, render: function () {
            ...
            e.clsPageType = this.getPageType(), e.ad = this.settings.ad;
            try {
            ...
            var i = [], a = [];
            for (var s in t.links)t.links.hasOwnProperty(s) && (t.links[s].name = s, a.push(t.links[s]));
            for (var n in t.bars)t.bars.hasOwnProperty(n) && (t.bars[n].name = n, i.push(t.bars[n]));
            return {
            ...
            var i, a = this.$trigger.filter('[data-name="' + t + '"]').find(".J-count");
            e > 0 ? (i = e > 99 ? "99+" : e, a.html(i).show()) : a.hide()
        }, updateLayout: function () {
            var t = $(window).height(), e = this.$content.eq(this.m.index), i = e.find(".J-panel-header").outerHeight(),
                a = e.find(".J-panel-footer").outerHeight(), s = e.find(".J-panel-content");
            s.css("height", t - i - a)
        }, bindEvent: function () {
            var t = this;
            $(window).unbind("resize.toolbar").bind("resize.toolbar", function () {
                ...
                t.handleHover(!0, $(this)), $(this).hasClass("jdm-tbar-tab-jdvip") && $(".poptip").length && $(".poptip").fadeOut(300, function () {
                    $(".poptip").hide()
                })
            });
            var e = null;
            this.settings.$el.delegate(".J-trigger", "mouseleave", function () {
                t.handleHover(!1, $(this)), $(this).hasClass("jdm-tbar-tab-jdvip") && $(".poptip").length && !t.opened && (clearTimeout(e), e = setTimeout(function () {
                ...
                var a = $(this), r = s(t), l = n(a), d = o(a);
                (!d || e() || i()) && t.preventDefault()
            }), this.isIE6 && (this.$w.bind("resize", function () {
                t.resetLayout("height"), t.resetLayout("right")
            ...
            var e = this, i = this.$trigger.index(t), a = "bar" === t.attr("data-type"),
                s = {index: i, login: t.attr("data-login"), name: t.attr("data-name"), iframe: t.attr("data-iframe")};
            return e.opened && i === e.$content.data("last") ? void e.close() : (this.m = s, !!a && void(s.login ? seajs.use("TTF_UNIT/login/1.0.0/login", function (t) {
                t.isLogin(function (i) {
                    i ? e.open(s) : t({
                        modal: !0, firstCheck: !1, complete: function (t) {
                            e.open(s), e.onLogin(s)
                        }
                    })
                })
            }) : this.open(s)))
        }, switchTo: function (t) {
            this.eventDispatcher.trigger(t.name + "PanelOpen"), this.$trigger.removeClass(this.triggerClick), this.$trigger.eq(t.index).parent().hasClass("jdm-toolbar-header") || this.$trigger.eq(t.index).addClass(this.triggerClick);
            ...
            var e = this, i = this.$content.eq(t.index), a = i.find(".J-panel-header"), s = i.find(".J-panel-content"),
            ...
            if (t.iframe) {
                ...
                s.html(o), this.settings.bars[t.name].loaded = !0
            } else {
                var r = this.settings.bars[t.name].js, l = this.settings.bars[t.name].css;
                seajs.use([r, l], function (i) {
                    i && new i({$header: a, $content: s, $footer: n}), e.settings.bars[t.name].loaded = !0
                })
            }
        }, open: function (t) {
            this.$wrap.addClass(this.toolbarOpen), this.opened ? this.onSwitch(t) : this.onOpen(t), this.opened = !0, this.switchTo(t)
        }, close: function () {
            this.$wrap.removeClass(this.toolbarOpen), this.$trigger.removeClass(this.triggerClick).removeClass(this.triggerHover), this.opened = !1, this.onClose()
            ...
            var t, e = this.$trigger.filter('[data-name="cart"]').find(".J-count");
            t = e.is(":visible") ? parseInt(e.text(), 10) : 0, this.setBubbleCount("cart", t + 1), this.$newItemInCartHint.stop().show().css({opacity: 1}).delay(800).fadeOut(600)
