            ...
            <div class="form ">
                    ...
                    <div class="item-ifo">
                        ...
                        <label class="img">
                            <img style="cursor:pointer;width:100px;height:33px;display:block;"
                                 src2="https://authcode.taotao.com/verify/image?a=1&amp;acid=1359c13d-7daa-4a2a-972d-f09e09e6605a&amp;uid=1359c13d-7daa-4a2a-972d-f09e09e6605a"
                                                                 onclick="this.src= document.location.protocol +'//authcode.taotao.com/verify/image?a=1&amp;acid=1359c13d-7daa-4a2a-972d-f09e09e6605a&amp;uid=1359c13d-7daa-4a2a-972d-f09e09e6605a&amp;yys='+new Date().getTime();$('#authcode').val('');"
                                 ver_colorofnoisepoint="#888888" id="TT_Verification1">
                        </label>
                        <label class="ftx23 hline">看不清？<br><a href="javascript:void(0)" class="flk13"
                                                              onclick="jQuery('#TT_Verification1').click();">换一张</a></label>
                    ...
                    <div class="item-ifo">
                        ...
                        <label class="mar">自动登录</label>
                            ...
                            <label class="mar" id="jdsafe">安全控件登录<div class="tip-safe" style="display:none;" id="tip-safe">安全控件可提高账户安全性，加密保护您的密码。</div></label>
                                                ...
                                                <label><a href="http://safe.taotao.com/findPwd/index.action" class="" clstag="passport|keycount|login|05">忘记密码?</a></label>
                        <div class="clr"></div>
                    </div>
                ...
                <div class="coagent hide" clstag="passport|keycount|login|07">
                    ...
                    <span class="btns qq"><s></s> <a href="javascript:void(0)"
                                                     onclick="window.location='http://qq.taotao.com/new/qq/login.aspx'+window.location.search;return false;">QQ</a></span>
                        <dl class="btns more-slide">
                            <dt><b>其它</b></dt>
                            <dd>
								<a href="javascript:void(0)"
                                               onclick="window.location='http://qq.taotao.com/new/netease/login.action'+window.location.search;return false;">网易</a>
								<a style="margin-left:30px;" href="javascript:void(0)"
                                               onclick="window.location='http://qq.taotao.com/new/renren/login.action'+window.location.search;return false;">人人</a>
								<br>
								<a href="javascript:void(0)"
                                               onclick="window.location='http://qq.taotao.com/new/douban/login.action'+window.location.search;return false;">豆瓣</a>
								<a style="margin-left:30px;" href="javascript:void(0)"
                                               onclick="window.location='http://qq.taotao.com/new/sohu/login.action'+window.location.search;return false;">搜狐</a>
                                <br>
								<a href="javascript:void(0)"
                                               onclick="window.location='http://qq.taotao.com/new/kaixin001/login.action'+window.location.search;return false;">开心</a>
								<a style="margin-left:30px;" href="javascript:void(0)"
                                               onclick="window.location='http://qq.taotao.com/new/alipay/login.aspx'+window.location.search;return false;">支付宝</a>
								<br>								
								<a href="javascript:void(0)"
                                               onclick="window.location='http://qq.taotao.com/new/qihao/login.action'+window.location.search;return false;">奇虎360</a>
								<a style="margin-left:10px;" href="javascript:void(0)"
                                               onclick="window.location='http://qq.taotao.com/new/sina/login.action'+window.location.search;return false;">新浪微博</a>
                            </dd>
                        </dl>
