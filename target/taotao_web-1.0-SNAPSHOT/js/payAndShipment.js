...
function doDealCalenderInfo(dataResult) {
	...
	if (dataResult.suportShipType == "1") { //如果只支持311
	    ...
	    if (dataResult.suportShipType == "0") {
	      $("#jdShip-span-tip .qmark-icon").attr('data-tips', '由淘淘公司负责配送，速度很快，还接受上门刷卡付款服务')
	    } else {
...
function doSaveInstallDate(venderId) {
  ...
  $("#install_date_div_" + venderId).html('<span class="ftx-03">安装时间：</span>' + installDate_date + " " + installDate_weekDay + '<span class="ftx-03 ml5">只针对淘淘上门安装商品</span>');
...
function doSaveOtherInstallDate(venderId){
   ...
   $("#otherinstall_date_div_" + venderId).html('<span class="ftx-03">安装时间：</span>' + installDate_date + " " + installDate_weekDay +'<span class="ftx-03 ml5">只针对淘淘上门安装商品</span>');
  ...
  $('body').dialog({
    ...
    onReady: function() {
      ...
      if (curSelPayWay == "0") {
        ...
        $(".pay_way_remark").html('<span class="qmark"></span><a class="ftx-05" href="http://help.taotao.com/help/question-61.html#posz" target="_blank">货到付款的订单上写的是POS刷卡，可以换成现金支付吗？</a>');
        $(".pay_way_remark").show();
      }
      if (curSelPayWay == "2") {
        $(".pay_way_remark").html('<span class="qmark"></span><a class="ftx-05" href="http://help.taotao.com/help/question-61.html#zptt" target="_blank">使用支票支付，抬头写什么？</a><br><span class="qmark"></span><a class="ftx-05" href="http://help.taotao.com/help/question-61.html#zpxz" target="_blank">支票支付有金额和区域的限制么？</a><br><span class="qmark"></span><a class="ftx-05" href="http://help.taotao.com/help/question-61.html#zpjed" target="_blank">支票支付的订单，我支票的金额比订单实际金额多怎么办？</a>');
        $(".pay_way_remark").show();
      }
    }
  });
  ...
  //自提点不可用状态
    ...
    for (var i = 0; i < selfPick.noSupportSelfPickSkuList.length; i++) {
      _arr[i] = "<div class='goods-item'>\
                  <div class='p-img'>\
                    <a target='_blank' href='http://item.taotao.com/" + selfPick.noSupportSelfPickSkuList[i].id + ".html'><img src='http://img.taotao.com/N4/" + selfPick.noSupportSelfPickSkuList[i].imgUrl + "' alt=''></a>\
                  </div>\
                  <div class='p-name'>\
                    <a target='_blank' href='http://item.taotao.com/" + selfPick.noSupportSelfPickSkuList[i].id + ".html'>" + selfPick.noSupportSelfPickSkuList[i].name + "+</a>\
                  </div>\
                </div>";
    }
